...
public final class HqdmObjectFactory {
     ...
     * @throws HqdmException If the HqdmObject could not be built.
     */
    public static Thing create(final String iri, final List<Pair<String, String>> pairs)
            throws HqdmException {
            try {
    ...
    static {
            ...
            iriToClassMap.put(HQDM.CLASS_OF_INTENTIONALLY_CONSTRUCTED_OBJECT, 
                    ClassOfIntentionallyConstructedObject.class);
            ...
            iriToClassMap.put(HQDM.CLASS_OF_STATE_OF_ORDINARY_PHYSICAL_OBJECT, 
                    ClassOfStateOfOrdinaryPhysicalObject.class);
            iriToClassMap.put(HQDM.CLASS_OF_STATE_OF_ORGANIZATION, ClassOfStateOfOrganization.class);
            iriToClassMap.put(HQDM.CLASS_OF_STATE_OF_ORGANIZATION_COMPONENT, 
                    ClassOfStateOfOrganizationComponent.class);
            ...
            iriToClassMap.put(HQDM.CLASS_OF_STATE_OF_SALES_PRODUCT_INSTANCE, 
                    ClassOfStateOfSalesProductInstance.class);
            ...
            iriToClassMap.put(HQDM.KIND_OF_INTENTIONALLY_CONSTRUCTED_OBJECT, 
                    KindOfIntentionallyConstructedObject.class);
            ...
            //iriToClassMap.put(HQDM.PARTICIPANT_IN_ACTIVITY_OR_ASSOCIATION, ParticipantInActivityOrAssociation.class);
            ...
            iriToClassMap.put(HQDM.STATE_OF_INTENTIONALLY_CONSTRUCTED_OBJECT, 
                    StateOfIntentionallyConstructedObject.class);
