...
public class ClassOfStateOfAssociationImpl extends HqdmObject implements ClassOfStateOfAssociation {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfStateOfAssociationImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfStateOfAssociationImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfStateOfAssociationImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfStateOfAssociation build() throws HqdmException {
            if (classOfStateOfAssociationImpl.hasValue(HAS_SUPERCLASS)
                    && classOfStateOfAssociationImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfStateOfAssociationImpl.hasValue(MEMBER__OF)
                    && classOfStateOfAssociationImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfStateOfAssociationImpl.hasValue(MEMBER_OF)
                    && classOfStateOfAssociationImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfStateOfAssociationImpl.hasValue(MEMBER_OF_)
                    && classOfStateOfAssociationImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfStateOfAssociationImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfStateOfAssociationImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfStateOfAssociationImpl;
        }
    }
}
