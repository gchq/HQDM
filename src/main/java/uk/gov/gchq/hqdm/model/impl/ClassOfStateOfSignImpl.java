...
import static uk.gov.gchq.hqdm.iri.HQDM.CLASS_OF_STATE_OF_SIGN;
...
public class ClassOfStateOfSignImpl extends HqdmObject implements ClassOfStateOfSign {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfStateOfSignImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfStateOfSignImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfStateOfSignImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfStateOfSign build() throws HqdmException {
            if (classOfStateOfSignImpl.hasValue(HAS_SUPERCLASS)
                    && classOfStateOfSignImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfStateOfSignImpl.hasValue(MEMBER__OF)
                    && classOfStateOfSignImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfStateOfSignImpl.hasValue(MEMBER_OF)
                    && classOfStateOfSignImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfStateOfSignImpl.hasValue(MEMBER_OF_)
                    && classOfStateOfSignImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfStateOfSignImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfStateOfSignImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfStateOfSignImpl;
        }
    }
}
