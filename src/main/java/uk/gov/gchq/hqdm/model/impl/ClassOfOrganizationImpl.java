...
import static uk.gov.gchq.hqdm.iri.HQDM.CLASS_OF_ORGANIZATION;
...
public class ClassOfOrganizationImpl extends HqdmObject implements ClassOfOrganization {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfOrganizationImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfOrganizationImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfOrganizationImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfOrganization build() throws HqdmException {
            if (classOfOrganizationImpl.hasValue(HAS_SUPERCLASS)
                    && classOfOrganizationImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfOrganizationImpl.hasValue(MEMBER__OF)
                    && classOfOrganizationImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfOrganizationImpl.hasValue(MEMBER_OF)
                    && classOfOrganizationImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfOrganizationImpl.hasValue(MEMBER_OF_)
                    && classOfOrganizationImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfOrganizationImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfOrganizationImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfOrganizationImpl;
        }
    }
}
