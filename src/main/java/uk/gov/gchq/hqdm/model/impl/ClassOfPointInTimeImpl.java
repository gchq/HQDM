...
public class ClassOfPointInTimeImpl extends HqdmObject implements ClassOfPointInTime {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfPointInTimeImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfPointInTimeImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfPointInTimeImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfPointInTime build() throws HqdmException {
            if (classOfPointInTimeImpl.hasValue(HAS_SUPERCLASS)
                    && classOfPointInTimeImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfPointInTimeImpl.hasValue(MEMBER__OF)
                    && classOfPointInTimeImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfPointInTimeImpl.hasValue(MEMBER_OF)
                    && classOfPointInTimeImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfPointInTimeImpl.hasValue(MEMBER_OF_)
                    && classOfPointInTimeImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfPointInTimeImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfPointInTimeImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfPointInTimeImpl;
        }
    }
}
