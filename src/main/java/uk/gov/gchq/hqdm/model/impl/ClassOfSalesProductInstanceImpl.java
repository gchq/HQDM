...
import static uk.gov.gchq.hqdm.iri.HQDM.CLASS_OF_SALES_PRODUCT_INSTANCE;
...
public class ClassOfSalesProductInstanceImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfSalesProductInstanceImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfSalesProductInstanceImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfSalesProductInstanceImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfSalesProductInstance build() throws HqdmException {
            if (classOfSalesProductInstanceImpl.hasValue(HAS_SUPERCLASS)
                    && classOfSalesProductInstanceImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfSalesProductInstanceImpl.hasValue(MEMBER__OF)
                    && classOfSalesProductInstanceImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfSalesProductInstanceImpl.hasValue(MEMBER_OF)
                    && classOfSalesProductInstanceImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfSalesProductInstanceImpl.hasValue(MEMBER_OF_)
                    && classOfSalesProductInstanceImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfSalesProductInstanceImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfSalesProductInstanceImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfSalesProductInstanceImpl;
        }
    }
}
