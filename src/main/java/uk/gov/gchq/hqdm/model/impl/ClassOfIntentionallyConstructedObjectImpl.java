...
import static uk.gov.gchq.hqdm.iri.HQDM.CLASS_OF_INTENTIONALLY_CONSTRUCTED_OBJECT;
    ...
    public static class Builder {
        ...
        public Builder(final IRI iri) {
            classOfIntentionallyConstructedObjectImpl =
                    new ClassOfIntentionallyConstructedObjectImpl(iri);
        }
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfIntentionallyConstructedObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfIntentionallyConstructedObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfIntentionallyConstructedObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfIntentionallyConstructedObject build() throws HqdmException {
            if (classOfIntentionallyConstructedObjectImpl.hasValue(HAS_SUPERCLASS)
                    && classOfIntentionallyConstructedObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfIntentionallyConstructedObjectImpl.hasValue(MEMBER__OF)
                    && classOfIntentionallyConstructedObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfIntentionallyConstructedObjectImpl.hasValue(MEMBER_OF)
                    && classOfIntentionallyConstructedObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfIntentionallyConstructedObjectImpl.hasValue(MEMBER_OF_)
                    && classOfIntentionallyConstructedObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfIntentionallyConstructedObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfIntentionallyConstructedObjectImpl
                            .value(PART__OF_BY_CLASS)
                            .isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfIntentionallyConstructedObjectImpl;
        }
    }
}
