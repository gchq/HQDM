...
public class KindOfPositionImpl extends HqdmObject implements KindOfPosition {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            kindOfPositionImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            kindOfPositionImpl.addValue(MEMBER_OF_, classOfClassOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            kindOfPositionImpl.addValue(PART__OF_BY_CLASS, classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public KindOfPosition build() throws HqdmException {
            if (kindOfPositionImpl.hasValue(HAS_SUPERCLASS)
                    && kindOfPositionImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (kindOfPositionImpl.hasValue(MEMBER__OF)
                    && kindOfPositionImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (kindOfPositionImpl.hasValue(MEMBER_OF)
                    && kindOfPositionImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (kindOfPositionImpl.hasValue(MEMBER_OF_)
                    && kindOfPositionImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (kindOfPositionImpl.hasValue(PART__OF_BY_CLASS)
                    && kindOfPositionImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return kindOfPositionImpl;
        }
    }
}
