...
public class ClassOfEventImpl extends HqdmObject implements ClassOfEvent {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfEventImpl.addValue(
                    CONSISTS__OF_BY_CLASS, classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public final Builder member_Of_(
            ...
            classOfEventImpl.addValue(MEMBER_OF_, classOfClassOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfEventImpl.addValue(PART__OF_BY_CLASS, classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfEvent build() throws HqdmException {
            if (classOfEventImpl.hasValue(HAS_SUPERCLASS)
                    && classOfEventImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfEventImpl.hasValue(MEMBER__OF)
                    && classOfEventImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfEventImpl.hasValue(MEMBER_OF)
                    && classOfEventImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfEventImpl.hasValue(MEMBER_OF_)
                    && classOfEventImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfEventImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfEventImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfEventImpl;
        }
    }
}
