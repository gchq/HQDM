...
public class ClassOfInstalledObjectImpl extends HqdmObject implements ClassOfInstalledObject {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfInstalledObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfInstalledObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfInstalledObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfInstalledObject build() throws HqdmException {
            if (classOfInstalledObjectImpl.hasValue(HAS_SUPERCLASS)
                    && classOfInstalledObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfInstalledObjectImpl.hasValue(MEMBER__OF)
                    && classOfInstalledObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfInstalledObjectImpl.hasValue(MEMBER_OF)
                    && classOfInstalledObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfInstalledObjectImpl.hasValue(MEMBER_OF_)
                    && classOfInstalledObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfInstalledObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfInstalledObjectImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfInstalledObjectImpl;
        }
    }
}
