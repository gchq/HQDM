...
public class ClassOfStateOfSystemImpl extends HqdmObject implements ClassOfStateOfSystem {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfStateOfSystemImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfStateOfSystemImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfStateOfSystemImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfStateOfSystem build() throws HqdmException {
            if (classOfStateOfSystemImpl.hasValue(HAS_SUPERCLASS)
                    && classOfStateOfSystemImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfStateOfSystemImpl.hasValue(MEMBER__OF)
                    && classOfStateOfSystemImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfStateOfSystemImpl.hasValue(MEMBER_OF)
                    && classOfStateOfSystemImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfStateOfSystemImpl.hasValue(MEMBER_OF_)
                    && classOfStateOfSystemImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfStateOfSystemImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfStateOfSystemImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfStateOfSystemImpl;
        }
    }
}
