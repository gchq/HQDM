...
public class CurrencyImpl extends HqdmObject implements Currency {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            currencyImpl.addValue(CONSISTS__OF_BY_CLASS, classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public final Builder member_Of_(
            ...
            currencyImpl.addValue(MEMBER_OF_, classOfClassOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            currencyImpl.addValue(PART__OF_BY_CLASS, classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public Currency build() throws HqdmException {
            if (currencyImpl.hasValue(HAS_SUPERCLASS)
                    && currencyImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (currencyImpl.hasValue(MEMBER__OF)
                    && currencyImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (currencyImpl.hasValue(MEMBER_OF)
                    && currencyImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (currencyImpl.hasValue(MEMBER_OF_)
                    && currencyImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (currencyImpl.hasValue(PART__OF_BY_CLASS)
                    && currencyImpl.value(PART__OF_BY_CLASS).isEmpty()) {
