...
import static uk.gov.gchq.hqdm.iri.HQDM.KIND_OF_BIOLOGICAL_SYSTEM_COMPONENT;
...
public class KindOfBiologicalSystemComponentImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            kindOfBiologicalSystemComponentImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            kindOfBiologicalSystemComponentImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            kindOfBiologicalSystemComponentImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public KindOfBiologicalSystemComponent build() throws HqdmException {
            if (kindOfBiologicalSystemComponentImpl.hasValue(HAS_SUPERCLASS)
                    && kindOfBiologicalSystemComponentImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (kindOfBiologicalSystemComponentImpl.hasValue(MEMBER__OF)
                    && kindOfBiologicalSystemComponentImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (kindOfBiologicalSystemComponentImpl.hasValue(MEMBER_OF)
                    && kindOfBiologicalSystemComponentImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (kindOfBiologicalSystemComponentImpl.hasValue(MEMBER_OF_)
                    && kindOfBiologicalSystemComponentImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (kindOfBiologicalSystemComponentImpl.hasValue(PART__OF_BY_CLASS)
                    && kindOfBiologicalSystemComponentImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return kindOfBiologicalSystemComponentImpl;
        }
    }
}
