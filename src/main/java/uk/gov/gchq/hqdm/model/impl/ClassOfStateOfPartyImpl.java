...
public class ClassOfStateOfPartyImpl extends HqdmObject implements ClassOfStateOfParty {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfStateOfPartyImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfStateOfPartyImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfStateOfPartyImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfStateOfParty build() throws HqdmException {
            if (classOfStateOfPartyImpl.hasValue(HAS_SUPERCLASS)
                    && classOfStateOfPartyImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfStateOfPartyImpl.hasValue(MEMBER__OF)
                    && classOfStateOfPartyImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfStateOfPartyImpl.hasValue(MEMBER_OF)
                    && classOfStateOfPartyImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfStateOfPartyImpl.hasValue(MEMBER_OF_)
                    && classOfStateOfPartyImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfStateOfPartyImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfStateOfPartyImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfStateOfPartyImpl;
        }
    }
}
