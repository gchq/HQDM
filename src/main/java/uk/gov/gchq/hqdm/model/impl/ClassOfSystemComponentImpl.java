...
public class ClassOfSystemComponentImpl extends HqdmObject implements ClassOfSystemComponent {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfSystemComponentImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfSystemComponentImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfSystemComponentImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfSystemComponent build() throws HqdmException {
            if (classOfSystemComponentImpl.hasValue(HAS_SUPERCLASS)
                    && classOfSystemComponentImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfSystemComponentImpl.hasValue(MEMBER__OF)
                    && classOfSystemComponentImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfSystemComponentImpl.hasValue(MEMBER_OF)
                    && classOfSystemComponentImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfSystemComponentImpl.hasValue(MEMBER_OF_)
                    && classOfSystemComponentImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfSystemComponentImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfSystemComponentImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfSystemComponentImpl;
        }
    }
}
