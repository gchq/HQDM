...
public class KindOfPhysicalObjectImpl extends HqdmObject implements KindOfPhysicalObject {
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            kindOfPhysicalObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            kindOfPhysicalObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            kindOfPhysicalObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public KindOfPhysicalObject build() throws HqdmException {
            if (kindOfPhysicalObjectImpl.hasValue(HAS_SUPERCLASS)
                    && kindOfPhysicalObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (kindOfPhysicalObjectImpl.hasValue(MEMBER__OF)
                    && kindOfPhysicalObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (kindOfPhysicalObjectImpl.hasValue(MEMBER_OF)
                    && kindOfPhysicalObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (kindOfPhysicalObjectImpl.hasValue(MEMBER_OF_)
                    && kindOfPhysicalObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (kindOfPhysicalObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && kindOfPhysicalObjectImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return kindOfPhysicalObjectImpl;
        }
    }
}
