...
public class ClassOfStateOfPhysicalObjectImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfStateOfPhysicalObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfStateOfPhysicalObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfStateOfPhysicalObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfStateOfPhysicalObject build() throws HqdmException {
            if (classOfStateOfPhysicalObjectImpl.hasValue(HAS_SUPERCLASS)
                    && classOfStateOfPhysicalObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfStateOfPhysicalObjectImpl.hasValue(MEMBER__OF)
                    && classOfStateOfPhysicalObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfStateOfPhysicalObjectImpl.hasValue(MEMBER_OF)
                    && classOfStateOfPhysicalObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfStateOfPhysicalObjectImpl.hasValue(MEMBER_OF_)
                    && classOfStateOfPhysicalObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfStateOfPhysicalObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfStateOfPhysicalObjectImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfStateOfPhysicalObjectImpl;
        }
    }
}
