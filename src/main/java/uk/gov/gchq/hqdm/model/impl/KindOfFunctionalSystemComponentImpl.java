...
import static uk.gov.gchq.hqdm.iri.HQDM.KIND_OF_FUNCTIONAL_SYSTEM_COMPONENT;
...
public class KindOfFunctionalSystemComponentImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            kindOfFunctionalSystemComponentImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            kindOfFunctionalSystemComponentImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            kindOfFunctionalSystemComponentImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public KindOfFunctionalSystemComponent build() throws HqdmException {
            if (kindOfFunctionalSystemComponentImpl.hasValue(HAS_SUPERCLASS)
                    && kindOfFunctionalSystemComponentImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (kindOfFunctionalSystemComponentImpl.hasValue(MEMBER__OF)
                    && kindOfFunctionalSystemComponentImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (kindOfFunctionalSystemComponentImpl.hasValue(MEMBER_OF)
                    && kindOfFunctionalSystemComponentImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (kindOfFunctionalSystemComponentImpl.hasValue(MEMBER_OF_)
                    && kindOfFunctionalSystemComponentImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (kindOfFunctionalSystemComponentImpl.hasValue(PART__OF_BY_CLASS)
                    && kindOfFunctionalSystemComponentImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return kindOfFunctionalSystemComponentImpl;
        }
    }
}
