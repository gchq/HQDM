...
public class KindOfOrdinaryBiologicalObjectImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            kindOfOrdinaryBiologicalObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            kindOfOrdinaryBiologicalObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            kindOfOrdinaryBiologicalObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public KindOfOrdinaryBiologicalObject build() throws HqdmException {
            if (kindOfOrdinaryBiologicalObjectImpl.hasValue(HAS_SUPERCLASS)
                    && kindOfOrdinaryBiologicalObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (kindOfOrdinaryBiologicalObjectImpl.hasValue(MEMBER__OF)
                    && kindOfOrdinaryBiologicalObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (kindOfOrdinaryBiologicalObjectImpl.hasValue(MEMBER_OF)
                    && kindOfOrdinaryBiologicalObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (kindOfOrdinaryBiologicalObjectImpl.hasValue(MEMBER_OF_)
                    && kindOfOrdinaryBiologicalObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (kindOfOrdinaryBiologicalObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && kindOfOrdinaryBiologicalObjectImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return kindOfOrdinaryBiologicalObjectImpl;
        }
    }
}
