...
import static uk.gov.gchq.hqdm.iri.HQDM.KIND_OF_ORDINARY_FUNCTIONAL_OBJECT;
...
public class KindOfOrdinaryFunctionalObjectImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            kindOfOrdinaryFunctionalObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            kindOfOrdinaryFunctionalObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            kindOfOrdinaryFunctionalObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public KindOfOrdinaryFunctionalObject build() throws HqdmException {
            if (kindOfOrdinaryFunctionalObjectImpl.hasValue(HAS_SUPERCLASS)
                    && kindOfOrdinaryFunctionalObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (!kindOfOrdinaryFunctionalObjectImpl.hasValue(INTENDED_ROLE_BY_CLASS)) {
                throw new HqdmException("Property Not Set: intended_role_by_class");
            }
            if (kindOfOrdinaryFunctionalObjectImpl.hasValue(MEMBER__OF)
                    && kindOfOrdinaryFunctionalObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (kindOfOrdinaryFunctionalObjectImpl.hasValue(MEMBER_OF)
                    && kindOfOrdinaryFunctionalObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (kindOfOrdinaryFunctionalObjectImpl.hasValue(MEMBER_OF_)
                    && kindOfOrdinaryFunctionalObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (kindOfOrdinaryFunctionalObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && kindOfOrdinaryFunctionalObjectImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return kindOfOrdinaryFunctionalObjectImpl;
        }
    }
}
