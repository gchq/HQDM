...
import static uk.gov.gchq.hqdm.iri.HQDM.CLASS_OF_STATE_OF_FUNCTIONAL_OBJECT;
...
public class ClassOfStateOfFunctionalObjectImpl extends HqdmObject
    ...
    public static class Builder {
        ...
        public final Builder consists__Of_By_Class(
            ...
            classOfStateOfFunctionalObjectImpl.addValue(CONSISTS__OF_BY_CLASS,
        ...
        public final Builder member_Of_(
            ...
            classOfStateOfFunctionalObjectImpl.addValue(MEMBER_OF_,
        ...
        public final Builder part__Of_By_Class(
                final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
            classOfStateOfFunctionalObjectImpl.addValue(PART__OF_BY_CLASS,
                    classOfSpatioTemporalExtent.getIri());
            return this;
        }
        ...
        public ClassOfStateOfFunctionalObject build() throws HqdmException {
            if (classOfStateOfFunctionalObjectImpl.hasValue(HAS_SUPERCLASS)
                    && classOfStateOfFunctionalObjectImpl.value(HAS_SUPERCLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: has_superclass");
            }
            if (classOfStateOfFunctionalObjectImpl.hasValue(MEMBER__OF)
                    && classOfStateOfFunctionalObjectImpl.value(MEMBER__OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member__of");
            }
            if (classOfStateOfFunctionalObjectImpl.hasValue(MEMBER_OF)
                    && classOfStateOfFunctionalObjectImpl.value(MEMBER_OF).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of");
            }
            if (classOfStateOfFunctionalObjectImpl.hasValue(MEMBER_OF_)
                    && classOfStateOfFunctionalObjectImpl.value(MEMBER_OF_).isEmpty()) {
                throw new HqdmException("Property Not Set: member_of_");
            }
            if (classOfStateOfFunctionalObjectImpl.hasValue(PART__OF_BY_CLASS)
                    && classOfStateOfFunctionalObjectImpl.value(PART__OF_BY_CLASS).isEmpty()) {
                throw new HqdmException("Property Not Set: part__of_by_class");
            }
            return classOfStateOfFunctionalObjectImpl;
        }
    }
}
